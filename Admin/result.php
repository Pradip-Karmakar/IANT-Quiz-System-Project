...
$id =  $_GET['id'];
if ($dc->getTable("delete from result where rid='$id'")) {
$delsucmsg = "Result Has Successfully Deleted";
}else{
    ...
    <div class="content-wrapper mt-4">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Resul</li>
        </ol>
        <!-- Example DataTables Card-->
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-users"></i> result List
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "select a.*,b.*,c.*,d.bid from result a , course b , batch c , user d where a.cid = b.cid and a.id = d.id and d.bid = c.bid";
                  ...
                  <tr>
                    ...
                    <td><a href="report.php?id=<?= $row['rid'] ?>" class="btn btn-success btn-block">Get Report</a></td>
                    <td><center><a href="result.php?id=<?php echo $row['rid']; ?>&action=delete" class="link-color" onClick="return confirm('Are You Sure You Want To Delete This Qestion')"><i class="fa fa-trash-o" aria-hidden="true"></i> </a></center></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
