...
$id = $_POST['editid'];
$sql = $dc->getTable("update course set cname='$_POST[cname]' where cid='$id'");
if($sql){
}else{
}
}
...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark myfont" id="page-top">
    ...
    <div class="content-wrapper mt-4">
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-users"></i> Courses List
            <a href="addc.php" class="btn btn-success" style="float: right;">Add Course</a>
          </div>
          <div class="card-body">
              ...
              <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><center><a href="course.php?id=<?php echo $row['cid']; ?>&action=edit" class="link-color"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a></center></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
      ...
      $id =  $_GET['id'];
      $recieve = $dc->getRow("select * from course where cid = '$id'");
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="container">
                <form method="post" id="test" action="course.php" autocomplete="off">
                  <div class="row">
                    <div class="col-12">
                      <h2 class="myfont">Edit Course</h2>
                      <br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <input type="text" name="cname" id="cname" class="form-control" autocomplete="off" value="<?php echo $recieve['cname']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <input type="hidden" name="editid" id="editid" class="form-control" value="<?php echo $recieve['cid']; ?>">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
