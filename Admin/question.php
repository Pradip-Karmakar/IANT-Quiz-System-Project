...
$id =  $_GET['id'];
if ($dc->getTable("delete from question where qid='$id'")) {
$delsucmsg = "Question Has Successfully Deleted";
}else{
...
$id = $_POST['editid'];
$sql = $dc->getTable("update question set que='$_POST[que]' , o1 = '$_POST[o1]' , o2 = '$_POST[o2]' , o3 = '$_POST[o3]' , o4 = '$_POST[o4]' , ans = '$_POST[ans]' , pset = '$_POST[pset]' , cid = '$_POST[cid]' where qid='$id'");
if($sql){
  $sucup = "Question Update Successfully";
}else{
...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark myfont" id="page-top">
    ...
    <div class="content-wrapper mt-4">
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-users"></i> Questions List
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered" id="example" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "select a.*,b.cname from question a , course b where a.cid = b.cid";
                  ...
                  <tr>
                    ...
                    <td><a href="question.php?id=<?php echo $row['qid']; ?>&action=edit" class="link-color"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
                    <a href="question.php?id=<?php echo $row['qid']; ?>&action=delete" class="ml-2 link-color" onClick="return confirm('Are You Sure You Want To Delete This Qestion')"><i class="fa fa-trash-o" aria-hidden="true"></i></a></i> </a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
      ...
      $id =  $_GET['id'];
      $recieve = $dc->getRow("select a.*,b.* from question a , course b where a.cid = b.cid and a.qid = '$id'");
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="container">
                <form method="post" id="test" action="question.php" autocomplete="off">
                  <div class="row">
                    <div class="col-12">
                      <h2 class="myfont">Edit Question</h2>
                      <br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="que" id="que" class="form-control" autocomplete="off" value="<?php echo $recieve['que']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="o1" id="o1" class="form-control" autocomplete="off" value="<?php echo $recieve['o1']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="o2" id="o2" class="form-control" autocomplete="off" value="<?php echo $recieve['o2']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="o3" id="o3" class="form-control" autocomplete="off" value="<?php echo $recieve['o3']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="o4" id="o4" class="form-control" autocomplete="off" value="<?php echo $recieve['o4']; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="ans" id="ans" class="form-control" autocomplete="off" value="<?php echo $recieve['ans']; ?>" onkeypress="return isNumberans(event)" maxlength="1" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        ...
                        <input type="text" name="pset" id="pset" class="form-control" autocomplete="off" value="<?php echo $recieve['pset']; ?>" onkeypress="return isNumberans(event)" maxlength="1" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <input type="hidden" name="editid" id="editid" class="form-control" value="<?php echo $recieve['qid']; ?>">
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
