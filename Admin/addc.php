...
{
$cname = $_POST['cname'];
$save = "insert into course(cname) values('$cname')";
          ...
          <div class="row">
            <div class="col">
              <div class="form-group">
                 <label for="cname" class="control-label">Enter Course Name</label>
                <input type="text" name="cname" id="cname" class="form-control" autocomplete="off" onkeypress="return isNumber(event)" required>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col">
              <div class="form-group">
                <input type="submit" name="btn-addc" value="Add Course" class="btn btn-block btn-primary">
              </div>
            </div>
          </div>
        </form>
